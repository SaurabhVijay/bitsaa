...
var openFB = (function () {
    ...
    function login(callback, options) {
        ...
        // In app browser load start handler: Used when running in Cordova only
        ...
        // In app browser exit handler: Used when running in Cordova only
        function loginWindow_exitHandler() {
            console.log('exit and remove listeners');

//            if(WL.Client.getEnvironment() == 'iphone') {
//            	$('#videobg').play();
//        		$('.PageIndex').append('<video width="100%" height="100%" autoplay="" id="videobg11" loop="" muted="" poster="images/bgImage.png" webkit-playsinline=""><source src="css/bm.mp4" type="video/mp4"></source></video>');	
//        	}
